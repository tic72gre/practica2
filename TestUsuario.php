<?php
    ...
    require 'header.php';
    require 'footer.php';
echo "<br><br><br><font size='5' color='#black'><br><br><center><b>Registros</b></font></center><br>";
    //Creamos un objeto
    $usuario = new Usuario();
...
<div class='table-responsive sok_font'>
    <form name='alumno' action='TestUsuario.php' method='POST'>
        <table class="table table-bordered">
            ...
            <tr>
                <td colspan="2" align="center"><input type="submit" name="submit" value="Ingresar" class="button_sok"></td>
            </tr>
            <tr>
